...
@section('content')
<div class="py-3 mb-4 shadow-sm bg-waning border-top">
    <div class="container">
        <h6 class="mb-0">
            <a href="{{url('category')}}">
                Categories
                ...
                <div class="col-md-8">
                    <h2 class="mb-0">
                        ...
                        @if($products->trending == '1')
                            <label style="font-size: 16px;" class="badge bg-danger trending_tag float-end">Trending</label>
                        @endif
                    </h2>
                    <hr>
                    <label class="me-3">Original Price : <s>ksh {{$products->original_price}}</s></label>
                    <label class="fw-bold float-right">Selling Price : ksh {{$products->selling_price}}</label>
                    <p class="mt-3">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-3">
                            ...
                            <div class="input-group text-center mb-3">
                                ...
                                <input type="text" name="qiantity"  value="1" class="form-control qty-input text-center"/>
